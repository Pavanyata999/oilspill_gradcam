...
class HybridOilSpillModel(nn.Module):
    ...
    def forward(self, x):
        ...
        # Final fusion - removed ReLU to preserve logits for sigmoid
        output = self.fusion_bn(self.fusion_conv(weighted_combined))
        
        return output

    def get_gradcam_target_layer(self):
        # Return the attention layer as the target for GradCAM
        return self.attention[0]  # The Conv2d layer in attention
